...
tags:
  - mathematics
description: the key record of probability and statistixcs.
mathjax: true
...
影响试验指标的因素很多，进行方差分析的时候，我们总是在可控因素中选取，并且尽量少而精。

**目的：**判断哪些因素对于试验指标有着显著性影响；影响显著因素的好水平是什么；因素之间是否有交互作用；一个因素的各个水平之间是否有显著性差异
